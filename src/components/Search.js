...
function Search({ inputValue, handleInputChange }) {
    return (
        <div className="border rounded-lg p-2 w-50 border-slate-500 hover:border-slate-300 second:bg-red-600 md:visible">
            ...
            <input type="text"
                className="flex bg-transparent target:border-cyan-50 text-slate-300 placeholder-slate-400 placeholder:italic focus:outline-none px-1 text-sm"
                placeholder='Kimi ariyorsunuz?'
                value={inputValue}
