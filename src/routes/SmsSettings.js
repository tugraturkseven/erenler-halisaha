      ...
      <div className="flex flex-col justify-center items-center gap-7">
        ...
        <div className="flex flex-col justify-center items-center">
          ...
          <select
            ...
            onChange={(e) => handleSelectedAlertTime(e)}
            value={options[alertIndex]}
          >
                ...
                smsTemplates.map((template, index) => {
                  return (
                    <tr key={template.id}>
                      ...
                      <td className="text-left font-semibold line-clamp-5 text-ellipsis truncate text-wrap overflow-hidden">
                        {template.message}
                      </td>
                      <td>
                        <button
